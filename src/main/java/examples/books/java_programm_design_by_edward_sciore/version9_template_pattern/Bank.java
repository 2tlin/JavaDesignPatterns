...
import examples.books.java_programm_design_by_edward_sciore.version9_template_pattern.accounts.InterestChecking;
import examples.books.java_programm_design_by_edward_sciore.version9_template_pattern.accounts.RegularChecking;
import examples.books.java_programm_design_by_edward_sciore.version9_template_pattern.accounts.SavingsAccount;
...
public class Bank {
    ...
    public Bank(Map<Integer, BankAccount> accounts, int nextacct) { // constructor injection
    ...
    public void addInterest() {
        // transparent implementation of addInterest
        for (BankAccount ba : accounts.values())
            ba.addInterest();
    }
}